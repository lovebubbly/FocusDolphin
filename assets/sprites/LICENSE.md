...
Generation prompt summary: cute focus whale desktop pet, polished 2D sticker mascot style, teal-blue palette, 4 columns by 10 rows, calm idle rows plus happy reward rows, flat green chroma-key background, no text or watermark.
