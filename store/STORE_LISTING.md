...
| --- | --- |
| Name | FocusWhale |
| Interface languages | Korean and English, selected from the browser locale; English fallback |
...
> 방해 사이트 앞에 필요한 만큼의 멈춤을 더하고, 완료한 집중으로 고래를 성장시키는 로컬 우선 집중 도우미.
