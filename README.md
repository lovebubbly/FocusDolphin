...
`FocusWhale` was the unreleased development codename. Legacy filenames, storage keys, alarm namespaces, theme identifiers, test fixtures, and historical QA evidence may retain that string so installed development data remains compatible and earlier evidence stays truthful. The public repository is [lovebubbly/FocusDolphin](https://github.com/lovebubbly/FocusDolphin); its Issues and privacy-policy URLs were verified live on 2026-07-13. Chrome and Whale dashboard records remain independent publication records.
...
The integrated Focus Dolphin tree has passed build, typecheck, **264 application tests**, **9 release-package tests**, **542 / 542 locale parity**, deterministic atlas/icon generation, release verification, dependency and sensitive-data scans, and a detached clean-checkout rebuild. The exact archive is 3,715,534 bytes with 31 entries and SHA-256 `9477352d13105d1176c3cf540550b5a0252cbb2422528d92b943820bba1f5048`. The extracted tree passes comprehensive Chrome for Testing and ordinary Naver Whale journeys plus bilingual layout QA; five current store screenshots have replaced the historical whale collateral. Full fingerprints and report paths are recorded in [QA.md](QA.md).
...
- Goal 8 production and documentation were prepared by **OpenAI Codex (GPT-5)** at Choi Yunseong's request. Release evidence and store collateral were refreshed by **OpenAI Codex (GPT-5)** on **2026-07-13 KST**.
